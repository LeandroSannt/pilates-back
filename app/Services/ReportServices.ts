export default class ReportServices {
  ...
  async financialReport() {
    ...
    //     // this.calcPercentRate(student.plan.value,student.plan.amount_installmentplan)
    //     //  ,
    //     // ...student.toJSON()
    //   };
    ...
    // }, 0);
    // var sum_amount_receivable = studentExpiration.reduce(function (
    //   soma,
    //   atual
    // ) {
    ...
    // const data = {
    //   sum_percent_rate: new Intl.NumberFormat("pt-BR", {
    //     style: "currency",
    //     currency: "BRL",
    //   }).format(Number(sum_percent_rate.toFixed(2))),
    //   sum_amount_receivable: new Intl.NumberFormat("pt-BR", {
    //     style: "currency",
    //     currency: "BRL",
    //   }).format(Number(receible.toFixed(2))),
    //   sum_value: new Intl.NumberFormat("pt-BR", {
    //     style: "currency",
    //     currency: "BRL",
    //   }).format(Number(sum_value.toFixed(2))),
    //   studentExpiration,
    // };
    // return {
    //   data: data,
